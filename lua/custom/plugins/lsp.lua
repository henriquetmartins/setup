  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        vim.api.nvim_buf_set_keymap(0, 'i', '<tab>', 'pumvisible() ? "<c-n>" : "<tab>"', { expr = true, noremap = true })
        vim.api.nvim_buf_set_keymap(0, 'i', '<s-tab>', 'pumvisible() ? "<c-p>" : "<s-tab>"', { expr = true, noremap = true })
